...
# command
#LANE_DETECTOR, LANE_ANALYZER, SEND_DATA, DATA_RECORD, StartFrame, EndFrame, YAW_ANGLE, PITCH_ANGLE, IPM-HK or HK, theta_coef
command1="./LaneDetector64 1 1 611 0.0 0.1 1 0.5 " 
echo $command1
